...
class UserWithRolesServiceTest {
  ...
  void editUserWithRoles() {
    ...
    UserWithRolesRequest user1 = new UserWithRolesRequest("u1New", "new_Password", "newMail@a.dk", false);
  ...
  void addUserWithRolesWithNoRole() {
    ...
    UserWithRolesRequest user = new UserWithRolesRequest("u5", "new_Password", "xx@x.dk", false);
