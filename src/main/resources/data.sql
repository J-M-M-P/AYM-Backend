...
-- Orders
INSERT INTO orders (created, customer_user_name, is_shipped) VALUES (NOW(), "user 1", true);
INSERT INTO orders (created, customer_user_name, is_shipped) VALUES (NOW(), "user 1", false);
INSERT INTO orders (created, customer_user_name, is_shipped) VALUES (NOW(), "user 1", true);


-- Product-Order associations
INSERT INTO product_order (product_id, qty, order_id_fk) VALUES (3, 13, 1); -- ANNABELLE is associated with ring category
